 ...
 */
 ...
 module.exports = async (client) => {
    ...
    client.on("ready", async (client) => {
        console.log(pico.green(`Logged in as ${client.user.tag}!`));
        console.log(`Currently in ${pico.green(client.guilds.cache.size)} ${client.guilds.cache.size == 1 ? "Server" : "Servers"}`);
